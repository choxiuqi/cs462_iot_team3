...
def get_health_update(chat_id):
    ...
    if (rpi_time_diff > 60):
        errors.append("Raspberry pi (Window)")
    ...
    if (rpi_time_diff_2 > 60):
        errors.append("Raspberry pi (TV)")
    timestamps.append(("Raspberry pi (TV)",last_pi_rec_2))

    # get reading for out pir1
    ...
    if (pir_time_diff > 60):
        errors.append("PIR motion sensor (Window)")
    timestamps.append(("PIR motion sensor (Window)",last_pir_rec))


    # get reading for out pir2
    ...
    if (pir_time_diff_2 > 60):
        errors.append("PIR motion sensor (TV)")
    timestamps.append(("PIR motion sensor (TV)",last_pir_rec_2))
